...
* цвят на очите на ергена (за да помогнем на дамите да не бъркат цвета на очите на Виктор)
...
Клас BachelorHouse - "Къщата на ергените", организира участниците, следи за елиминациите и симулира церемониите на розата
Член-данни:
...
* Добавяме 3 ергена и 10 дами.
* Ергените се редуват да раздават роза на дама по техен избор(ако тя я приеме).
* Всяка дама, която не получи роза през кръга бива елиминирана от предаването.
* Кръговете продължават, докато останат точно толкова дами колкото и ергени.

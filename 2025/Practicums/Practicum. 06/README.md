...
# Задача 9:
Имплементирайте клас Game, който съдържа следните член-данни (полета): title, price, isAvailable. Член-данната title е от тип символен низ с произволна дължина(Какво следва от това?).- Дaти
